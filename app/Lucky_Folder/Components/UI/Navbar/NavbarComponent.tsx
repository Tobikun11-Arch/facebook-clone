...
export default function NavbarComponent() {
  return (
    <nav className='border-b-2 fixed w-full border-black md:flex md:justify-between px-5 items-center md:border-slate-300 md:bg-[rgb(36,37,38)]'>
      ...
      <div className='hidden md:flex items-center gap-2'>
        ...
        <div className='relative flex items-center'>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-search md:hidden lg:block absolute ml-3"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
          <input type='text' className='bg-[#3A3B3C] rounded-full px-9 py-2 hidden w-[100%] lg:block' placeholder='Search Facebook'></input>
          <div className='titte bg-[#3A3B3C] p-3 rounded-full lg:hidden'><span className=''><FaMagnifyingGlass></FaMagnifyingGlass></span></div>
        </div>
      ...
      <ul className='flex justify-evenly items-center md:gap-7'>
            ...
            <li className='p-5 text-2xl md:hidden'><GoBell/></li>
            <li className='p-5 text-2xl hidden md:block'><MdOutlineStorefront/></li>
      </ul>
